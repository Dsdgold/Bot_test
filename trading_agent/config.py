...
JOURNAL_SKIP_REVIEW_INTERVAL_HOURS = int(os.getenv("JOURNAL_SKIP_REVIEW_INTERVAL_HOURS", "4"))
...
TUNING_CYCLE_HOURS = int(os.getenv("TUNING_CYCLE_HOURS", "24"))
TUNING_LOOKBACK_TRADES = int(os.getenv("TUNING_LOOKBACK_TRADES", "200"))
TUNING_MIN_SAMPLE = int(os.getenv("TUNING_MIN_SAMPLE", "30"))
TUNING_MIN_CONFIDENCE_PCT = int(os.getenv("TUNING_MIN_CONFIDENCE_PCT", "70"))
PROBATION_TRADES = int(os.getenv("PROBATION_TRADES", "30"))
