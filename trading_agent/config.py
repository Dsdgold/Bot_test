...
SPIKE_CANDLE_ATR_MAX = float(os.getenv("SPIKE_CANDLE_ATR_MAX", "2.5"))
...
MAX_ALLOWED_SLIPPAGE_BPS = float(os.getenv("MAX_ALLOWED_SLIPPAGE_BPS", "2"))
...
# --- Cooldowns ---
# Quick cooldown: don't block too many opportunities
POST_LOSS_COOLDOWN_SEC = int(os.getenv("POST_LOSS_COOLDOWN_SEC", "10"))
REENTRY_COOLDOWN_CANDLES = int(os.getenv("REENTRY_COOLDOWN_CANDLES", "0"))
SAME_SIDE_LOSS_PAUSE_COUNT = int(os.getenv("SAME_SIDE_LOSS_PAUSE_COUNT", "5"))
SAME_SIDE_LOSS_PAUSE_SEC = int(os.getenv("SAME_SIDE_LOSS_PAUSE_SEC", "120"))
...
MARKET_SNAPSHOT_INTERVAL_SEC = int(os.getenv("MARKET_SNAPSHOT_INTERVAL_SEC", "60"))
ENABLE_EQUITY_TRACKING = os.getenv("ENABLE_EQUITY_TRACKING", "true").lower() == "true"
EQUITY_SNAPSHOT_INTERVAL_SEC = int(os.getenv("EQUITY_SNAPSHOT_INTERVAL_SEC", "120"))
...
TARGET_NET_PROFIT_USD = float(os.getenv("TARGET_NET_PROFIT_USD", "0.80"))
...
EQUITY_FLOOR_USDT = float(os.getenv("EQUITY_FLOOR_USDT", "15"))
MAX_OPEN_POSITIONS = int(os.getenv("MAX_OPEN_POSITIONS", "1"))

# --- Token optimization ---
LICENSE_CACHE_TTL_SEC = int(os.getenv("LICENSE_CACHE_TTL_SEC", "30"))
...
JOURNAL_SKIP_REVIEW_INTERVAL_HOURS = float(os.getenv("JOURNAL_SKIP_REVIEW_INTERVAL_HOURS", "0.5"))
...
TUNING_CYCLE_HOURS = float(os.getenv("TUNING_CYCLE_HOURS", "0.5"))
...
TUNING_FREEZE_DD_PCT = float(os.getenv("TUNING_FREEZE_DD_PCT", "8.0"))
ROLLBACK_THRESHOLD_PCT = float(os.getenv("ROLLBACK_THRESHOLD_PCT", "20"))
ROLLBACK_MAX_DD_PCT = float(os.getenv("ROLLBACK_MAX_DD_PCT", "8.0"))
ROLLBACK_WR_DROP_PCT = float(os.getenv("ROLLBACK_WR_DROP_PCT", "15"))
LOCKOUT_CYCLES = int(os.getenv("LOCKOUT_CYCLES", "3"))
META_LEARNING_INTERVAL_HOURS = float(os.getenv("META_LEARNING_INTERVAL_HOURS", "6"))
META_LEARNING_MAX_TOKENS = int(os.getenv("META_LEARNING_MAX_TOKENS", "300"))

# --- Strategy Evolution ---
STRATEGY_EVOLUTION_ENABLED = os.getenv("STRATEGY_EVOLUTION_ENABLED", "true").lower() == "true"
STRATEGY_EVOLUTION_HOURS = float(os.getenv("STRATEGY_EVOLUTION_HOURS", "12"))
STRATEGY_EVOLUTION_MIN_TRADES = int(os.getenv("STRATEGY_EVOLUTION_MIN_TRADES", "8"))
